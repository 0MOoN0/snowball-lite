...
- 状态：已完成
- 归档位置：`web/docs/desc/monorepo_transition`
- 当前结构：仓库已形成 `apps/frontend` + `apps/backend/web` 双工作区结构
- 兼容入口：根目录 `web` 保留为指向 `apps/backend/web` 的符号链接
...
- 根目录已建立统一长期文档入口 `docs/`
- lite 主链路已经完成前后端联调
- 本组 requirement 设计文档已经从 `web/docs/task/monorepo_transition` 归档到 `web/docs/desc/monorepo_transition`
...
- requirement 状态文档：`/Users/leon/projects/snowball-lite/web/docs/review/monorepo_transition/requirement-status.md`
...
| Task 04 | `04_backend_app_workspace_relocation_design.md` | 已把真实后端迁到 `apps/backend/web/`，根目录 `web` 保留兼容入口 | Task 03 + backend 收口归档 |
...
- 执行计划：`/Users/leon/projects/snowball-lite/web/docs/review/monorepo_transition/execution-plan.md`
- requirement 状态：`/Users/leon/projects/snowball-lite/web/docs/review/monorepo_transition/requirement-status.md`
- requirement 总结：`/Users/leon/projects/snowball-lite/web/docs/review/monorepo_transition/requirement-summary.md`
