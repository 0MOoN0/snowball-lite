...
<template>
  ...
  <div :class="[`${prefixCls}-container`, 'relative bg-[var(--el-bg-color)]']" ref="contentDetailWrap">
    <Sticky :offset="offset">
      <div
        :class="[
          `${prefixCls}-header`,
          'flex border-b border-[var(--el-border-color)] h-50px items-center text-center bg-[var(--el-bg-color)] pr-10px'
        ]"
      >
