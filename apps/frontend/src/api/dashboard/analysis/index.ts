...
export const getGridStrategySummaryApi = (): Promise<IResponse<any>> => {
  return request.get({ url: '/api/dashboard/grid-strategy-summary' })
}

export const getOverallTradeAnalysisApi = (): Promise<IResponse<any>> => {
  return request.get({ url: '/api/dashboard/overall-trade-analysis' })
}
